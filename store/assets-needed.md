...
### Icon (128x128 PNG)
See `extension/icons/ICONS.md` for design brief.
...
- Side by side: original WebP image → saved as PNG
- Show file sizes to demonstrate conversion
- Caption: "Convert between formats instantly — all in your browser"

**Screenshot 4: Format Guide**
- Simple infographic showing when to use each format:
